...
| Execute published-surface and disposable-consumer assurance | `assurance/` | Public workflow/action inventory, local fixtures, changed hosted cases, receipt schema/writer/validator and exact-candidate admission. |
